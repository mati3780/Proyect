angular
    .module('webApp')
    .controller('requirenteVerificarPDFController', ['$scope', '$routeParams', '$resource', '$http', '$uibModal', 'Tramite', '$sce', 'FileSaver', 'Blob', requirenteVerificarPDFController]);

function requirenteVerificarPDFController($scope, $routeParams, $resource, $http, $uibModal, Tramite, $sce, FileSaver, Blob) {
    var vm = this;
