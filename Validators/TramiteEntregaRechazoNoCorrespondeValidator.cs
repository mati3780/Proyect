...
{
    public class TramiteEntregaRechazoNoCorrespondeValidator : AbstractValidator<TramiteEntregaRechazoNoCorrespondeDto>, ITramiteActionValidator
    {
        private readonly IRepositorio<Tramite> _tramiteRepositorio;

        public TramiteEntregaRechazoNoCorrespondeValidator(IRepositorio<Tramite> tramiteRepositorio)
        {
        ...
        private bool ValidarPropiedad(TramiteEntregaRechazoNoCorrespondeDto item)
        {
        ...
        private bool ValidarEstado(TramiteEntregaRechazoNoCorrespondeDto item)
        {
