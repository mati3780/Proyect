...
{
    public class TramiteValidacionRechazoVisualizacionValidator : AbstractValidator<TramiteValidacionRechazoVisualizacionDto>, ITramiteActionValidator
    {
        private readonly IRepositorio<Tramite> _tramiteRepositorio;

        public TramiteValidacionRechazoVisualizacionValidator(IRepositorio<Tramite> tramiteRepositorio)
        {
        ...
        private bool ValidarPropiedad(TramiteValidacionRechazoVisualizacionDto item)
        {
        ...
        private bool ValidarEstado(TramiteValidacionRechazoVisualizacionDto item)
        {
